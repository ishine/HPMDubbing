...
def main(args, configs):
    ...
    dataset2 = Dataset("train.txt", preprocess_config2, train_config, sort=True, drop_last=True, diff_audio=False)
        ...
        for batchs in loader:
            for batch in batchs:
                ...
                if step % log_step == 0:
                    ...
                    if loss_model == 1:
                        message2 = "Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, Pitch Loss: {:.4f}, Energy Loss: {:.4f}, Pitch MAE: {:.4f}, Energy MAE: {:.4f}".format(
                            *losses
                        )
                    elif loss_model == 2:
                        message2 = "Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, Pitch Loss: {:.4f}, Energy Loss: {:.4f}, mel MSE: {:.4f}, mel_log MSE: {:.4f}".format(
                            *losses
                        )
                    elif loss_model == 3:
                        message2 = "Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, Pitch Loss: {:.4f}, Energy Loss: {:.4f}, Pitch MAE: {:.4f}, Energy MAE: {:.4f}, mel MSE: {:.4f}, mel_log MSE: {:.4f}".format(
                            *losses
                        )
                    elif loss_model == 4:
                        message2 = "Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, Pitch Loss: {:.4f}, Energy Loss: {:.4f}, Pitch MAE: {:.4f}, Energy MAE: {:.4f}, mel MSE: {:.4f}, mel_log MSE: {:.4f}, Emo Cross: {:.4f}".format(
                            *losses
                        )
                    else:
